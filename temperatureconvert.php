    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
            <fieldset class="fieldset">
                ...
                <div id="converter"><label for="temp">Enter The Temperature You Wish to Convert:</label>
                    <input for="temp" name="temp" id="temp" type="number" value="<?php if (isset($_POST['temp'])) {
    echo htmlspecialchars($_POST['temp']);
}
?>">
                </div>

                <div id="unit-1"><label for="unit_1">Converting From:</label>
                    <ul class="radio-unit-1">
                ...
                <div id="unit-2"><label for="unit_2">Converting To:</label>
                    <ul class="radio-unit-2">
...
?>
                ...
                <li><a href="https://validator.w3.org/nu/?doc=https://ellencodes.com/it262wn22/homeworks/p1TempConversion/tempconvert.php"
                        target="_blank">HTML Validation</a></li>
                <li><a href="https://jigsaw.w3.org/css-validator/validator?uri=https://ellencodes.com/it262wn22/homeworks/p1TempConversion/tempconvert.php"
                        target="_blank">CSS Validation</a></li>
            </ul>
